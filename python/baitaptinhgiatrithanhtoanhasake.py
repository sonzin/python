...
def tinhtoangiatricaclan(total):     
    print('Thanh toán lần 1 sẽ là: ',total*int(payment1)/100)
    print('Thanh toán lần 2 sẽ là: ',total*int(payment2)/100)
    print('Thanh toán lần 3 sẽ là: ',total*int(payment3)/100)
